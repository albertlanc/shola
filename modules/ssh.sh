ssh_menu() {
    while true; do
        ...
        echo -e "\033[0;34m ┌── \033[0;33mSSH, SSHWS & UDP CUSTOM MANAGER\033[0;34m ──────────────────────┐\033[0m"
        ...
        case $ssh_opt in
            1|01|2|02)
                ...
                clear
                echo -e "\033[0;34m ┌── \033[0;33mSYSTEM ACCOUNT CREATED (SSH / UDP / OVPN)\033[0;34m ────────────┐\033[0m"
                ...
                echo -e "\033[0;34m ├─ \033[0;34mACTIVE PORTS \033[0;34m──────────────────────────────────────────┤\033[0m"
                ...
                echo -e "\033[0;34m │\033[0;36m  UDP Custom     : \033[1;37m$P_UDPC\033[0m"
                echo -e "\033[0;34m │\033[0;36m  OpenVPN        : \033[1;37m1194 (TCP/UDP)\033[0m"
                echo -e "\033[0;34m ├─ \033[0;34mUDP CUSTOM PAYLOAD \033[0;34m────────────────────────────────────┤\033[0m"
                echo -e "\033[0;34m │\033[0;36m  IP/Host : \033[36m$DOMAIN\033[0m"
                echo -e "\033[0;34m │\033[0;36m  Port    : \033[36m$P_UDPC\033[0m"
                echo -e "\033[0;34m │\033[0;36m  Auth    : \033[36m$user:$pass\033[0m"
            ...
            7|07) 
                while true; do
                    ...
                    echo -e "\033[0;34m ├─────────────────────────────────────────────────────────┤\033[0m"
                    TMP_ONLINE=$(mktemp)
                    ps -eo user,comm | grep -E 'sshd|dropbear|openvpn' | grep -v "^root" | awk '{print $1}' | sort | uniq -c > "$TMP_ONLINE"
                    ...
                    rm -f "$TMP_ONLINE"
                    echo -e "\033[0;34m └─────────────────────────────────────────────────────────┘\033[0m"
                    echo -ne "\n\033[0;32mEnter a Username to kick (or leave blank to return): \033[0m"
                    read -r target_user
                    if [ -z "$target_user" ]; then break; fi
