draw_dashboard() {
    ...
    printf " \033[1;36m│\033[0m 🐧 \033[1;37m%-12.12s\033[0m : \033[1;36m%-27.27s\033[1;36m│\033[0m\n" "OS" "$OS_INFO"
    printf " \033[1;36m│\033[0m 🌐 \033[1;37m%-12.12s\033[0m : \033[1;36m%-27.27s\033[1;36m│\033[0m\n" "Domain" "$HOSTNAME"
    printf " \033[1;36m│\033[0m 🕒 \033[1;37m%-12.12s\033[0m : \033[1;36m%-27.27s\033[1;36m│\033[0m\n" "Time" "$DATE"
    printf " \033[1;36m│\033[0m ⚡ \033[1;37m%-12.12s\033[0m : \033[1;36m%-27.27s\033[1;36m│\033[0m\n" "Uptime" "$UPTIME"
    printf " \033[1;36m│\033[0m 👥 \033[1;37m%-12.12s\033[0m : \033[1;36m%-27.27s\033[1;36m│\033[0m\n" "Online Users" "$SSH_USERS (SSH) | $XRAY_USERS (XRAY)"
    printf " \033[1;36m│\033[0m 🆔 \033[1;37m%-12.12s\033[0m : \033[1;36m%-27.27s\033[1;36m│\033[0m\n" "IP Address" "$IP"
    printf " \033[1;36m│\033[0m ⚙️  \033[1;37m%-12.12s\033[0m : \033[0mXR:%b \033[0mSSH:%b \033[0mOV:%b \033[0mHY:%b   \033[1;36m│\033[0m\n" "Services" "$XRAY_RAW" "$SSH_RAW" "$OVPN_RAW" "$HY2_RAW"
    echo -e "\033[1;36m ╰──────────────────────────────────────────────╯\033[0m"
    echo -e ""

    # 4. Main Menu Dual-Button Grid
